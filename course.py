...
class CourseClass:
    def __init__(self, root):
        ...
        lb2_duration = Label(self.root, text="Duration", font=("goudy old style", 15, 'bold'), bg='white')
        lb2_duration.place(x=10, y=100)

        lb3_charges = Label(self.root, text="Charges", font=("goudy old style", 15, 'bold'), bg='white')
        lb3_charges.place(x=10, y=140)

        lb4_description = Label(self.root, text="Description", font=("goudy old style", 15, 'bold'), bg='white')
        lb4_description.place(x=10, y=180)
    ...
    def delete(self):
        ...
        try:
            if self.var_course.get() == "":
                ...
                row = cur.fetchone()
                if row is None:
                    messagebox.showerror("Error", "Please select course from the list dirst", parent=self.root)
                else:
